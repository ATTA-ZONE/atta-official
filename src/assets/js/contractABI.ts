...
export const c_atta_vote_abi = [
	...
	},
	{
		...
		"outputs": [
			{
				"internalType": "contract IERC721_Config",
				"name": "",
				"type": "address"
			}
		],

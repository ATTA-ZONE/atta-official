<template>
  ...
  <div class="charitybox">
      <div class="titlebox">
          <h1 class="SiYuan-light">{{$t('charity_tit')}} | {{$t('charity_tit2')}}</h1>
      ...
      <div class="contentbox">
        <div class="ssrseriesbox">
            <div class="title flex">
                <span class="SiYuan-light" @click="showssrbool = !showssrbool">{{$t('charity_ssr_tit')}}</span>
        ...
        <div class="rseriesbox" v-if="!showssrbool">
            <div class="title flexbetween">
                <span class="SiYuan-light">{{$t('charity_r_tit')}}</span>
            </div>
            <div class="imgscontentbox flexbetween">
        ...
        <div class="nseriesbox" v-if="!showssrbool">
            <div class="title flexbetween">
                <span class="SiYuan-light">{{$t('charity_n_tit')}}</span>
            </div>
            <div class="imgscontentbox flexbetween">
        ...
        <div class="nftseriesbox">
            <div class="title flex">
                <span class="SiYuan-light" @click="showssrbool2 = !showssrbool2">{{$t('charity_nft_tit')}}</span>

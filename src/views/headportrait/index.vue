    ...
    <div class="headportraitbox">
        <div class="bannerbox">
            <div class="logobox flex">
                <a href="https://www.bazhuayu.io/mobile/tc/specialitem.html" target="_blank">{{$t('faces_2')}}</a>
...
export default defineComponent({
  ...
  setup() {
    ...
    onMounted(() => {
        if (window.location.href.indexOf('?scrollview=true') > -1 && !isbool.value) {
            document.getElementById('contentbox1').scrollIntoView();
            isbool.value = true;
        }
